...
from langchain.output_parsers import DatetimeOutputParser  #← Output Parser인 DatetimeOutputParser를 가져옵니다.
from langchain.schema import HumanMessage

output_parser = DatetimeOutputParser() #← DatetimeOutputParser를 초기화한다.
...
output = output_parser.parse(result.content) #← 출력 결과를 분석하여 날짜 및 시간 형식으로 변환한다.
